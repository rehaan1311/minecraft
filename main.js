...
console.log("whan up arrow key is pressed,x= "+player_x+" ,y="+player_y);
...
function down(){
    ...
    player_y=player_y+block_image_height;
    console.log("block image height="+block_image_height);
    console.log("whan down arrow key is pressed,x= "+player_x+" ,y="+player_y);
    canvas.remove(player_object);
    player_update();
    }
    }
    ...
    function left(){
        ...
        console.log("whan left arrow key is pressed,x= "+player_x+" ,y="+player_y);
        canvas.remove(player_object);
        player_update();
        }
        }
